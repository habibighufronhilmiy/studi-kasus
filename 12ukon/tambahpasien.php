            ...
            <div class="col-4">
                ...
                <form action="koneksi.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mb-3" name="idpasien" readonly placeholder="ID Pasien AUTO">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            ...
                            <input type="radio" class="form-check-input" name="keterangan" value="sudah-vaksin"> sudah vaksin

                        </div>

                        <div class="form-check">

                            <input type="radio" class="form-check-input" name="keterangan" value="belum-vaksin"> belum vaksin
